...
Use "prazo":true quando o usuário perguntar QUANDO as contas parceladas vão terminar/acabar/quitar, qual é a última parcela, até quando vai pagar, ou algo do tipo "qual o último para pagar isso?" como acompanhamento de uma pergunta sobre parcelas — nesse caso mantenha "tipo":"parcelas" (repita da consulta anterior se for um acompanhamento, usando o histórico da conversa) e deixe os outros campos ("periodo","categoria","status" etc.) como na consulta original. Deixe "prazo" null em consultas normais que só pedem o total ou a lista de parcelas.
